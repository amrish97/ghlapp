...
class TermsShowPage extends StatefulWidget {
  const TermsShowPage({super.key});

  @override
  State<TermsShowPage> createState() => _TermsShowPageState();
}

class _TermsShowPageState extends State<TermsShowPage> {
  @override
  void initState() {
      ...
      builder: (context, value, child) {
        return Scaffold(
          ...
          bottomNavigationBar: Visibility(
            visible: value.isAgreeTermsCondition == 0,
            child: Padding(
              ...
              child: CustomButton(
                ...
                onTap: () {
                  ...
                  value.postTermsCondition(context);
                },
              ),
            ),
          ),
